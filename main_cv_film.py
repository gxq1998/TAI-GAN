...
eval_interval = 20
save_interval = 20
data_dir = 'RealData_all85_allshifted_medfilt_withEQframes_withRVLVMYO.npz'
...
for epoch in range(init_epoch,num_epochs):
    ...
    if (epoch + 1) % eval_interval == 0:
        ...
        plot_loss(D_avg_eval_losses, G_avg_eval_losses, G_avg_losses, epoch, num_epochs, save=True, save_dir=save_dir+'eval_')
